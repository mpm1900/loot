...
export const specializedArmorRanges: any = {
    ...
    [ItemRarity.Rare]: {
        [ItemSubType.Charm]:    [10, 35],
        [ItemSubType.Ring]:     [10, 35],
        [ItemSubType.Head]:     [10, 35],
        [ItemSubType.Body]:     [10, 35],
        [ItemSubType.Footwear]: [10, 35],
        [ItemSubType.Gloves]:   [10, 35],
    },
    [ItemRarity.Masterwork]: {
        [ItemSubType.Charm]:    [15, 75],
        [ItemSubType.Ring]:     [15, 75],
        [ItemSubType.Head]:     [15, 75],
        [ItemSubType.Body]:     [15, 75],
        [ItemSubType.Footwear]: [15, 75],
        [ItemSubType.Gloves]:   [15, 75],
    },
}

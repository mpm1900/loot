    ...
    render() {
        ...
        return (
            <div className="ZeroGuage" style={{ height }}>
                <div className="ZeroGuage__fill" style={{width: `${100 * value / max}%`, height, backgroundColor: fills ? `rgb(${pickHex(fills[0], fills[1], value / max)})`:  `rgb(${getDefaultColor(value / max)})` }}></div>
                <div className="ZeroGuage__content" style={{ height, lineHeight: `${height}px` }}>
                    {children}
                </div>
            </div>
        )
